...
import { countries, initialValue, options, petFormSchema, typesService } from './ValidationSchema';
    ...
    <div className="formWrapper">
      ...
      >
        <Form className="form">
          ...
          <OtherField
            options={typesService}
            type="select"
            label="Вид абоніменту"
            name="typeService"
          />
