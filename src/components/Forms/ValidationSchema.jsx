...
export const petFormSchema = Yup.object().shape({
  ...
  owner: Yup.string()
    .required("Власник тварини є обов'язковим!")
    .min(3, 'Має бути не менше 3-х символів'),
  ...
  anotherService: Yup.string()
    .required('Має бути обов’язковим')
    .max(120, 'Має бути не більше 120-ти символів'),
  gender: Yup.string()
    .required('Стать є обов’язковою')
    .oneOf(['Хлопчик', 'Дівчинка'], 'Оберіть стать'),
  password: Yup.string()
